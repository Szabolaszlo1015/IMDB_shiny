# Webscraping shiny app - April 2022
# (C)Laszlo Szabo
# https://github.com/Szabolaszlo1015/IMDB_shiny

## Functions==============================================================
# Function to sort a dataframe by coloumn
sort.by.column <- function(df, column.name) {
  df[order(df[,column.name], decreasing = T ),]
} 

# Function to calculate points to add based on number of Oscars
...
# Scrape number of oscars (not working)
